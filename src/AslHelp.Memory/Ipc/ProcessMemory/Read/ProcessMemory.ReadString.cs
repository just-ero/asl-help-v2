...
public partial class ProcessMemory
{
    ...
    private unsafe string ReadAnsiString(int maxLength, nuint baseAddress, params int[] offsets)
    {
        sbyte[]? rented = null;
    ...
    private unsafe string ReadUnicodeString(int maxLength, nuint baseAddress, params int[] offsets)
    {
        char[]? rented = null;
    ...
    private unsafe string ReadAutoString(int maxLength, nuint baseAddress, params int[] offsets)
    {
